(()=>{
  ...
  function installBrand(){
    ...
    brand.innerHTML='<img class="brand-logo-img" src="edujob-logo.svg" alt=""><span class="brand-copy"><span class="brand-title">수도권<em>에듀잡</em></span><span class="brand-subtitle">좋은 선생님이, 더 좋은 교육을 만듭니다</span></span>';
    const top=qs('.top');
  ...
  function installMascot(){
    ...
    if(!qs('.radar-mascot-wrap',radar)){
      ...
      wrap.innerHTML='<span class="radar-speech">좋은 기회가<br>기다리고 있어요!</span><img class="radar-mascot" src="edujob-mascot.svg" alt="">';
